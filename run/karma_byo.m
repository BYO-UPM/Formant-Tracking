...
function [x_est, x_errVar, wav, params] = karma_byo(input, varargin)
...
switch algFlag
    case 1 % Run Extended Kalman Filter
        smooth = 0;
        [x_est x_errVar] = formantTrackEKSZ_byo(y, Fmatrix, Q, R, x0, formantInds, fs, bwStates, nP, smooth);    
